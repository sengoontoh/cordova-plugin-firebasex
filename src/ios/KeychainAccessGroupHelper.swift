...
//  Huckleberry
//
//  Created by Andrii Forkaliuk on 27.09.2022.
//

import Foundation
import Security

@objcMembers class KeyChainAccessGroupInfo: NSObject {
    public var prefix: String
    public var keyChainGroup: String
    public var rawValue: String
    
    init(prefix: String, keyChainGroup: String, rawValue: String) {
        self.prefix = prefix
...
@objcMembers class KeyChainAccessGroupHelper: NSObject {
    
    static func getAccessGroupInfo() -> KeyChainAccessGroupInfo? {
